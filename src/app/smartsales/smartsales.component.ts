import { Component, Inject, OnInit, Pipe, PipeTransform, PLATFORM_ID, ViewChild } from '@angular/core';
...
export class SmartsalesComponent implements OnInit {
  ...
  constructor(private _sanitizer: DomSanitizer, private _homeservice:HomeService, private common: CommonService, @Inject(PLATFORM_ID) private platform_id: any) { 
    // AOS.init();
  }
